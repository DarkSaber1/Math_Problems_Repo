# Task List 03 — Combinatorics for Probability
...
A **variation without repetition** is an ordered selection of $k$ elements from $n$ distinct elements, without reusing any element.

The number of such variations is
...
A **variation with repetition** is an ordered selection of length $k$ from $n$ possible symbols, where repetition is allowed.
...
## Arrangements of Repeated Types

Sometimes objects are not all distinct. If a collection contains repeated types, then swapping identical objects does not produce a new arrangement.
...
* **Arrangement with repeated types**
...
* a permutation,
* a combination,
* a variation without repetition,
* a variation with repetition,
* or an arrangement of repeated types.
...
# Task 06 – Variations Without Repetition
...
# Task 07 – Variations Without Repetition
...
# Task 08 – Variations With Repetition

A variation with repetition is an ordered selection in which the same element may appear more than once.
...
7. For each part of the problem, identify which counting idea is most relevant:
   ...
   * combinations,
   * variations without repetition,
   * arrangements with repeated types.
